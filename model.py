...
custom_prompt_template = """You are a Large Language Model (LLM) designed as a Medical AI ChatBot. Use the following pieces of information to construct meaningful responses to the user's questions. 
